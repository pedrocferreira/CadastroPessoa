...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE "+TABELA+"("+ID+" integer primary key autoincrement, "+NOME +" text not null, "+CPF+" in teger(11) not null unique,"+ IDADE +" integer(11) not null, " + EMAIL + " text not null, "+NASCIMENTO+" text not null, "+ FONE +" double(9) not null)";
        db.execSQL(sql);
